...
class basic_json // NOLINT(cppcoreguidelines-special-member-functions,hicpp-special-member-functions)
    : public ::rm::detail::json_base_class<CustomBaseClass>
{
  private:
    template<detail::value_t> friend struct detail::external_constructor;

    template<typename>
    friend class ::rm::json_pointer;
    // can be restored when json_pointer backwards compatibility is removed
    // friend ::rm::json_pointer<StringType>;

    template<typename BasicJsonType, typename InputType>
    friend class ::rm::detail::parser;
    friend ::rm::detail::serializer<basic_json>;
    template<typename BasicJsonType>
    friend class ::rm::detail::iter_impl;
    template<typename BasicJsonType, typename CharType>
    friend class ::rm::detail::binary_writer;
    template<typename BasicJsonType, typename InputType, typename SAX>
    friend class ::rm::detail::binary_reader;
    template<typename BasicJsonType, typename InputAdapterType>
    friend class ::rm::detail::json_sax_dom_parser;
    template<typename BasicJsonType, typename InputAdapterType>
    friend class ::rm::detail::json_sax_dom_callback_parser;
    friend class ::rm::detail::exception;

    /// workaround type for MSVC
    using basic_json_t = NLOHMANN_BASIC_JSON_TPL;
    using json_base_class_t = ::rm::detail::json_base_class<CustomBaseClass>;

  JSON_PRIVATE_UNLESS_TESTED:
    // convenience aliases for types residing in namespace detail;
    using lexer = ::rm::detail::lexer_base<basic_json>;

    template<typename InputAdapterType>
    static ::rm::detail::parser<basic_json, InputAdapterType> parser(
    ...
    {
        return ::rm::detail::parser<basic_json, InputAdapterType>(std::move(adapter),
               std::move(cb), allow_exceptions, ignore_comments);
    }

  private:
    using primitive_iterator_t = ::rm::detail::primitive_iterator_t;
    template<typename BasicJsonType>
    using internal_iterator = ::rm::detail::internal_iterator<BasicJsonType>;
    template<typename BasicJsonType>
    using iter_impl = ::rm::detail::iter_impl<BasicJsonType>;
    template<typename Iterator>
    using iteration_proxy = ::rm::detail::iteration_proxy<Iterator>;
    template<typename Base> using json_reverse_iterator = ::rm::detail::json_reverse_iterator<Base>;

    template<typename CharType>
    using output_adapter_t = ::rm::detail::output_adapter_t<CharType>;

    template<typename InputType>
    using binary_reader = ::rm::detail::binary_reader<basic_json, InputType>;
    template<typename CharType> using binary_writer = ::rm::detail::binary_writer<basic_json, CharType>;

  JSON_PRIVATE_UNLESS_TESTED:
    using serializer = ::rm::detail::serializer<basic_json>;

  public:
    using value_t = detail::value_t;
    /// JSON Pointer, see @ref rm::json_pointer
    using json_pointer = ::rm::json_pointer<StringType>;
    ...
    /// SAX interface type, see @ref rm::json_sax
    ...
    using binary_t = ::rm::byte_container_with_subtype<BinaryType>;
...
#pragma warning( pop )
  ...
  public:
    ...
    template < class ValueType, class BasicJsonType, detail::enable_if_t <
                   ...
                   && detail::is_getable<basic_json_t, ValueType>::value
                   && !std::is_same<value_t, detail::uncvref_t<ValueType>>::value, int > = 0 >
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_rm::json_pointer or rm::json_pointer<basic_rm::string_t>) // NOLINT(readability/alt_tokens)
    ValueType value(const ::rm::json_pointer<BasicJsonType>& ptr, const ValueType& default_value) const
    {
    ...
    template < class ValueType, class BasicJsonType, class ReturnType = typename value_return_type<ValueType>::type,
               detail::enable_if_t <
                   ...
                   && !std::is_same<value_t, detail::uncvref_t<ValueType>>::value, int > = 0 >
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_rm::json_pointer or rm::json_pointer<basic_rm::string_t>) // NOLINT(readability/alt_tokens)
    ReturnType value(const ::rm::json_pointer<BasicJsonType>& ptr, ValueType && default_value) const
    {
  ...
  public:
    ...
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_rm::json_pointer or rm::json_pointer<basic_rm::string_t>) // NOLINT(readability/alt_tokens)
    bool contains(const typename ::rm::json_pointer<BasicJsonType>& ptr) const
    {
        return ptr.contains(this);
    }
  ...
  public:
    ...
    ///             that is, replace `rm::iterator_wrapper(j)` with `j.items()`.
...
#undef JSON_IMPLEMENT_OPERATOR
  ...
  public:
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_rm::json_pointer or rm::json_pointer<basic_rm::string_t>) // NOLINT(readability/alt_tokens)
    reference operator[](const ::rm::json_pointer<BasicJsonType>& ptr)
    {
        return ptr.get_unchecked(this);
    }
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_rm::json_pointer or rm::json_pointer<basic_rm::string_t>) // NOLINT(readability/alt_tokens)
    const_reference operator[](const ::rm::json_pointer<BasicJsonType>& ptr) const
    {
        return ptr.get_unchecked(this);
    }
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_rm::json_pointer or rm::json_pointer<basic_rm::string_t>) // NOLINT(readability/alt_tokens)
    reference at(const ::rm::json_pointer<BasicJsonType>& ptr)
    {
        return ptr.get_checked(this);
    }
    ...
    template<typename BasicJsonType, detail::enable_if_t<detail::is_basic_json<BasicJsonType>::value, int> = 0>
    JSON_HEDLEY_DEPRECATED_FOR(3.11.0, basic_rm::json_pointer or rm::json_pointer<basic_rm::string_t>) // NOLINT(readability/alt_tokens)
    const_reference at(const ::rm::json_pointer<BasicJsonType>& ptr) const
    {
        return ptr.get_checked(this);
    }
...
JSON_HEDLEY_NON_NULL(1)
    ...
    inline ::rm::json operator ""_json(const char* s, std::size_t n)
#else
    inline ::rm::json operator "" _json(const char* s, std::size_t n)
#endif
{
    return ::rm::json::parse(s, s + n);
}
...
JSON_HEDLEY_NON_NULL(1)
#if !defined(JSON_HEDLEY_GCC_VERSION) || JSON_HEDLEY_GCC_VERSION_CHECK(4,9,0)
    inline ::rm::json::json_pointer operator ""_json_pointer(const char* s, std::size_t n)
#else
    inline ::rm::json::json_pointer operator "" _json_pointer(const char* s, std::size_t n)
#endif
{
    return ::rm::json::json_pointer(std::string(s, n));
}
...
NLOHMANN_BASIC_JSON_TPL_DECLARATION
struct hash<rm::NLOHMANN_BASIC_JSON_TPL> // NOLINT(cert-dcl58-cpp)
{
    std::size_t operator()(const rm::NLOHMANN_BASIC_JSON_TPL& j) const
    {
        return rm::detail::hash(j);
    }
};

// specialization for std::less<value_t>
template<>
struct less< ::rm::detail::value_t> // do not remove the space after '<', see https://github.com/nlohmann/json/pull/679
{
    /*!
    @brief compare two value_t enum values
    @since version 3.0.0
    */
    bool operator()(::rm::detail::value_t lhs,
                    ::rm::detail::value_t rhs) const noexcept
    {
#if JSON_HAS_THREE_WAY_COMPARISON
        return std::is_lt(lhs <=> rhs); // *NOPAD*
#else
        return ::rm::detail::operator<(lhs, rhs);
#endif
    }
};
...
NLOHMANN_BASIC_JSON_TPL_DECLARATION
inline void swap(::rm::NLOHMANN_BASIC_JSON_TPL& j1, ::rm::NLOHMANN_BASIC_JSON_TPL& j2) noexcept(  // NOLINT(readability-inconsistent-declaration-parameter-name, cert-dcl58-cpp)
    is_nothrow_move_constructible<::rm::NLOHMANN_BASIC_JSON_TPL>::value&&                          // NOLINT(misc-redundant-expression,cppcoreguidelines-noexcept-swap,performance-noexcept-swap)
    is_nothrow_move_assignable<::rm::NLOHMANN_BASIC_JSON_TPL>::value)
{
    j1.swap(j2);
}
    ...
    #if !defined(JSON_HEDLEY_GCC_VERSION) || JSON_HEDLEY_GCC_VERSION_CHECK(4,9,0)
        using ::rm::literals::json_literals::operator ""_json; // NOLINT(misc-unused-using-decls,google-global-names-in-headers)
        using ::rm::literals::json_literals::operator ""_json_pointer; //NOLINT(misc-unused-using-decls,google-global-names-in-headers)
    #else
        using ::rm::literals::json_literals::operator "" _json; // NOLINT(misc-unused-using-decls,google-global-names-in-headers)
        using ::rm::literals::json_literals::operator "" _json_pointer; //NOLINT(misc-unused-using-decls,google-global-names-in-headers)
    #endif
