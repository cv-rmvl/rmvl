...
RigidBodyInertia::RigidBodyInertia(double m_, const Vector &h_, const RotationalInertia &I_, bool) : m(m_), h(h_), I(I_) {
}

RigidBodyInertia::RigidBodyInertia(double m_, const Vector &c_, const RotationalInertia &Ic) : m(m_), h(m * c_) {
    // I=Ic-c x c x
