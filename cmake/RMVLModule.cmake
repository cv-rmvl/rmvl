...
function(rmvl_add_test test_name test_kind)
  ...
  if(NOT test_src)
    message(STATUS "Skipping empty ${test_kind_lower} test target: rmvl_${test_name}")
    return()
  endif()
...
macro(rmvl_set_properties _target)
  ...
  if(BUILD_WORLD)
    set_target_properties(rmvl_world ${ARGN})
  else()
...
macro(rmvl_link_directories _target)
  ...
  if(BUILD_WORLD)
    target_link_directories(rmvl_world ${ARGN})
  else()
...
macro(rmvl_link_libraries _target)
  ...
  if(BUILD_WORLD)
    target_link_libraries(rmvl_world ${ARGN})
  else()
