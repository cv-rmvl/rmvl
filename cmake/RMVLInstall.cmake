...
if(MSVC)
  ...
  elseif(MSVC_VERSION MATCHES "^19[56][0-9]$")
    set(RMVL_RUNTIME_forMSVC vc18)
  else()
...
if(MSVC)
  if(DEFINED RMVL_RUNTIME_forMSVC AND DEFINED RMVL_ARCH_forMSVC)
    ...
    set(RMVL_INSTALL_BINARIES_PREFIX "${RMVL_ARCH_forMSVC}/unknown")
  endif()
  ...
  set(RMVL_3P_LIB_INSTALL_PATH      "lib")
