...
function(_parse_assign content_line header_line source_read_line source_write_line)
  ...
  if(type_sym MATCHES "^bool|uint\\w*|size_t|int[0-9]+_t$")
...
function(rmvl_generate_msg file)
  ...
  foreach(n ${type_and_ids})
    ...
    if(array_type STREQUAL "FIXED_ARRAY")
      if(is_custom_type)
        ...
        if(type STREQUAL "string")
          ...
          string(APPEND serialize_content "        _res_.append(reinterpret_cast<const char *>(&v_size__), sizeof(uint32_t));\n")
    ...
    elseif(array_type STREQUAL "VARIABLE_ARRAY")
      ...
      string(APPEND serialize_content "    _res_.append(reinterpret_cast<const char *>(&${id}_size__), sizeof(uint32_t));\n")
      if(is_custom_type)
        string(APPEND serialize_content "    for (const auto &v : ${id})\n        _res_.append(v.serialize());\n")
      else()
        if(type STREQUAL "string")
    ...
    elseif(array_type STREQUAL "VARIABLE_ARRAY")
      string(APPEND deserialize_content "    uint32_t ${id}_size__ = *reinterpret_cast<const uint32_t *>(_p__);\n")
      string(APPEND deserialize_content "    _p__ += sizeof(uint32_t);\n")
      ...
      if(is_custom_type)
        ...
        if(type STREQUAL "string")
          ...
          string(APPEND deserialize_content "        uint32_t v_size__ = *reinterpret_cast<const uint32_t *>(_p__);\n")
          string(APPEND deserialize_content "        _p__ += sizeof(uint32_t);\n")
