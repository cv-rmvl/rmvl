...
if(BUILD_TESTS)
    ...
    if(NOT GTest_FOUND)
        ...
        rmvl_download(googletest URL "https://gitee.com/mirrors/googletest/repository/archive/main.zip")
    endif()
endif()
...
if(BUILD_PERF_TESTS)
    ...
    rmvl_download(benchmark GIT "https://gitee.com/mirrors/benchmark.git : v1.8.0")
