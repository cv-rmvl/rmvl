...
TEST(Algorithm_math, ew_topsis_basic_function) {
...
TEST(Algorithm_math, ew_topsis_custom_data) {
...
TEST(Algorithm_math, munkres_test1) {
...
TEST(Algorithm_math, munkres_test2) {
    std::vector<std::vector<double>> cost = {
        {2, 3, 4},
        {4, 3, 2},
        {3, 2, 4},
...
TEST(Algorithm_math, munkres_test3) {
    std::vector<std::vector<double>> cost = {
        {82, 83, 69, 92},
        {77, 37, 49, 92},
        {11, 69, 5, 86},
