 ...
 * @tparam MeasureDim 观测量个数
 *
 * @note 提供了形如 rm::KF21f 、 rm::KF21d 之类的类型别名，以头文件定义为准
 */
template <typename FloatTp, int StateDim, int MeasureDim>
...
using KF21f = KalmanFilter<float, 2, 1>;  //!< \f$2\times1\f$ 卡尔曼滤波器
using KF21d = KalmanFilter<double, 2, 1>; //!< \f$2\times1\f$ 卡尔曼滤波器

//! @cond
using KF31f = KalmanFilter<float, 3, 1>;  //!< \f$3\times1\f$ 卡尔曼滤波器
using KF31d = KalmanFilter<double, 3, 1>; //!< \f$3\times1\f$ 卡尔曼滤波器
using KF32f = KalmanFilter<float, 3, 2>;  //!< \f$3\times2\f$ 卡尔曼滤波器
using KF32d = KalmanFilter<double, 3, 2>; //!< \f$3\times2\f$ 卡尔曼滤波器
using KF42f = KalmanFilter<float, 4, 2>;  //!< \f$4\times2\f$ 卡尔曼滤波器
using KF42d = KalmanFilter<double, 4, 2>; //!< \f$4\times2\f$ 卡尔曼滤波器
using KF63f = KalmanFilter<float, 6, 3>;  //!< \f$6\times3\f$ 卡尔曼滤波器
using KF63d = KalmanFilter<double, 6, 3>; //!< \f$6\times3\f$ 卡尔曼滤波器
using KF64f = KalmanFilter<float, 6, 4>;  //!< \f$6\times4\f$ 卡尔曼滤波器
using KF64d = KalmanFilter<double, 6, 4>; //!< \f$6\times4\f$ 卡尔曼滤波器
using KF73f = KalmanFilter<float, 7, 3>;  //!< \f$7\times3\f$ 卡尔曼滤波器
using KF73d = KalmanFilter<double, 7, 3>; //!< \f$7\times3\f$ 卡尔曼滤波器
//! @endcond
 ...
 * @tparam MeasureDim 观测量个数
 *
 * @note 提供了形如 rm::EKF31f 、 rm::EKF31d 之类的类型别名，以头文件定义为准
 */
template <typename FloatTp, int StateDim, int MeasureDim>
...
using EKF31f = ExtendedKalmanFilter<float, 3, 1>;  //!< \f$3\times1\f$ 扩展卡尔曼滤波器
using EKF31d = ExtendedKalmanFilter<double, 3, 1>; //!< \f$3\times1\f$ 扩展卡尔曼滤波器

//! @cond
using EKF32f = ExtendedKalmanFilter<float, 3, 2>;  //!< \f$3\times2\f$ 扩展卡尔曼滤波器
using EKF32d = ExtendedKalmanFilter<double, 3, 2>; //!< \f$3\times2\f$ 扩展卡尔曼滤波器
using EKF42f = ExtendedKalmanFilter<float, 4, 2>;  //!< \f$4\times2\f$ 扩展卡尔曼滤波器
using EKF42d = ExtendedKalmanFilter<double, 4, 2>; //!< \f$4\times2\f$ 扩展卡尔曼滤波器
using EKF52f = ExtendedKalmanFilter<float, 5, 2>;  //!< \f$5\times2\f$ 扩展卡尔曼滤波器
using EKF52d = ExtendedKalmanFilter<double, 5, 2>; //!< \f$5\times2\f$ 扩展卡尔曼滤波器
using EKF53f = ExtendedKalmanFilter<float, 5, 3>;  //!< \f$5\times3\f$ 扩展卡尔曼滤波器
using EKF53d = ExtendedKalmanFilter<double, 5, 3>; //!< \f$5\times3\f$ 扩展卡尔曼滤波器
using EKF63f = ExtendedKalmanFilter<float, 6, 3>;  //!< \f$6\times3\f$ 扩展卡尔曼滤波器
using EKF63d = ExtendedKalmanFilter<double, 6, 3>; //!< \f$6\times3\f$ 扩展卡尔曼滤波器
using EKF64f = ExtendedKalmanFilter<float, 6, 4>;  //!< \f$6\times4\f$ 扩展卡尔曼滤波器
using EKF64d = ExtendedKalmanFilter<double, 6, 4>; //!< \f$6\times4\f$ 扩展卡尔曼滤波器
using EKF73f = ExtendedKalmanFilter<float, 7, 3>;  //!< \f$7\times3\f$ 扩展卡尔曼滤波器
using EKF73d = ExtendedKalmanFilter<double, 7, 3>; //!< \f$7\times3\f$ 扩展卡尔曼滤波器
using EKF74f = ExtendedKalmanFilter<float, 7, 4>;  //!< \f$7\times4\f$ 扩展卡尔曼滤波器
using EKF74d = ExtendedKalmanFilter<double, 7, 4>; //!< \f$7\times4\f$ 扩展卡尔曼滤波器
using EKF83f = ExtendedKalmanFilter<float, 8, 3>;  //!< \f$8\times3\f$ 扩展卡尔曼滤波器
using EKF83d = ExtendedKalmanFilter<double, 8, 3>; //!< \f$8\times3\f$ 扩展卡尔曼滤波器
using EKF84f = ExtendedKalmanFilter<float, 8, 4>;  //!< \f$8\times4\f$ 扩展卡尔曼滤波器
using EKF84d = ExtendedKalmanFilter<double, 8, 4>; //!< \f$8\times4\f$ 扩展卡尔曼滤波器
using EKF94f = ExtendedKalmanFilter<float, 9, 4>;  //!< \f$9\times4\f$ 扩展卡尔曼滤波器
using EKF94d = ExtendedKalmanFilter<double, 9, 4>; //!< \f$9\times4\f$ 扩展卡尔曼滤波器
//! @endcond
 ...
 * @tparam MeasureDim
 *
 * @note 提供了形如 rm::IEKF31f 、 rm::IEKF31d 之类的类型别名，以头文件定义为准
 */
template <typename FloatTp, int StateDim, int MeasureDim>
...
using IEKF31f = IteratedExtendedKalmanFilter<float, 3, 1>;  //!< \f$3\times1\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF31d = IteratedExtendedKalmanFilter<double, 3, 1>; //!< \f$3\times1\f$ 紧耦合迭代扩展卡尔曼滤波器

//! @cond
using IEKF32f = IteratedExtendedKalmanFilter<float, 3, 2>;  //!< \f$3\times2\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF32d = IteratedExtendedKalmanFilter<double, 3, 2>; //!< \f$3\times2\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF42f = IteratedExtendedKalmanFilter<float, 4, 2>;  //!< \f$4\times2\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF42d = IteratedExtendedKalmanFilter<double, 4, 2>; //!< \f$4\times2\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF52f = IteratedExtendedKalmanFilter<float, 5, 2>;  //!< \f$5\times2\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF52d = IteratedExtendedKalmanFilter<double, 5, 2>; //!< \f$5\times2\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF53f = IteratedExtendedKalmanFilter<float, 5, 3>;  //!< \f$5\times3\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF53d = IteratedExtendedKalmanFilter<double, 5, 3>; //!< \f$5\times3\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF63f = IteratedExtendedKalmanFilter<float, 6, 3>;  //!< \f$6\times3\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF63d = IteratedExtendedKalmanFilter<double, 6, 3>; //!< \f$6\times3\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF64f = IteratedExtendedKalmanFilter<float, 6, 4>;  //!< \f$6\times4\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF64d = IteratedExtendedKalmanFilter<double, 6, 4>; //!< \f$6\times4\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF73f = IteratedExtendedKalmanFilter<float, 7, 3>;  //!< \f$7\times3\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF73d = IteratedExtendedKalmanFilter<double, 7, 3>; //!< \f$7\times3\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF74f = IteratedExtendedKalmanFilter<float, 7, 4>;  //!< \f$7\times4\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF74d = IteratedExtendedKalmanFilter<double, 7, 4>; //!< \f$7\times4\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF83f = IteratedExtendedKalmanFilter<float, 8, 3>;  //!< \f$8\times3\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF83d = IteratedExtendedKalmanFilter<double, 8, 3>; //!< \f$8\times3\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF84f = IteratedExtendedKalmanFilter<float, 8, 4>;  //!< \f$8\times4\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF84d = IteratedExtendedKalmanFilter<double, 8, 4>; //!< \f$8\times4\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF94f = IteratedExtendedKalmanFilter<float, 9, 4>;  //!< \f$9\times4\f$ 紧耦合迭代扩展卡尔曼滤波器
using IEKF94d = IteratedExtendedKalmanFilter<double, 9, 4>; //!< \f$9\times4\f$ 紧耦合迭代扩展卡尔曼滤波器
//! @endcond
