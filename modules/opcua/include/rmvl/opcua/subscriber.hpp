...
struct FieldMetaData final {
     ...
     *
     * @param[in] val 变量，可参考 @ref Variable
     */
...
//! OPC UA 订阅者
class Subscriber : public Server {
public:
    /**
     * @brief 创建 OPC UA 订阅者
     *
     ...
     */
    Subscriber(std::string_view sub_name, const std::string &addr, uint16_t port = 4850U, const std::vector<UserConfig> &users = {});
