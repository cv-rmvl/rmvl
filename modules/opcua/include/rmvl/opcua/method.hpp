...
struct Argument final {
    ...
    DataType type{};           //!< 参数数据类型 @see rm::DataType
     ...
     * @return 方法参数信息
     */
    static Argument create(const std::string &name, DataType type, uint32_t dims = 1, const std::string &desc = "") { return {name, type, dims, desc}; }
};
