...
- <b class="tab-title">std 消息分组</b>
  ...
  <tr class="markdownTableRowEven">
    ...
    <td class="markdownTableBodyLeft">包含时间戳和坐标系 ID 的标准消息头</td>
  </tr>
  <tr class="markdownTableRowOdd">
  ...
  <tr class="markdownTableRowEven">
    ...
    <td class="markdownTableBodyLeft"><div class="fragment">
      <div class="line"><span class="keywordtype">int32</span> sec</div>
      <div class="line"><span class="keywordtype">uint32</span> nsec</div>
    </div></td>
    <td class="markdownTableBodyLeft">记录了自 1970 年 1 月 1 日以来的时间</td>
  </tr>
  <tr class="markdownTableRowOdd">
