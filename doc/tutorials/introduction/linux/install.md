...
- <b class="tab-title">快速安装</b>
  ...
  - `24.04` 对应的 OpenCV 版本是 `4.6.0`
  - `26.04` 对应的 OpenCV 版本是 `4.10.0`
...
- 获取压缩包，可选择对应的发行版，也可以是 `gpu`、`gpu_cuda<x>` 或 `cpu` 版本，下面以 1.26.0 的 cpu 版本为例
  <div class="fragment">
  <div class="line"><span class="keywordflow">curl</span> -SL https://github.com/microsoft/onnxruntime/releases/download/v1.26.0/onnxruntime-linux-x64-1.26.0.tgz -o onnxruntime-linux-x64-1.26.0.tgz</div>
  </div>
- 解压
  <div class="fragment">
  <div class="line"><span class="keywordflow">tar</span> -xf onnxruntime-linux-x64-1.26.0.tgz</div>
  </div>
- 安装（复制头文件与库文件）
  <div class="fragment">
  ...
  <div class="line"><span class="keywordflow">cd</span> onnxruntime-linux-x64-1.26.0</div>
